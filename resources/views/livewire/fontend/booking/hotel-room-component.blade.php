									...
									<div class="row">
										<div class="col-md-4">
											<div class="form-group">
												...
												<input type="text" name="code" id="code" wire:model="code" class="form-control" placeholder="ລະຫັດການຈອງ" disabled>
											</div>
										</div>
										<div class="col-md-4">
											<div class="form-group">
												<label for="name">ຊື່ຜູ້ຈອງ</label>
												<input type="text" name="name" id="name" wire:model="name" class="form-control" placeholder="ຊື່ຜູ້ຈອງ" {{$disname}}>
										...
										<div class="col-md-4">
											<div class="form-group">
												...
												<input type="text" name="tel" id="tel" wire:model="phone" class="form-control" placeholder="ເບີໂທ" {{$disphone}}>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="position-relative">
                                                ...
                                                <div class="card-img-overlay">
                                                    <a href="{{asset($item->img)}}" class="badge bg-dark stretched-link"
                                        ...
                                        <div class="col-md-8">
                                            <div class="card-body d-flex flex-column p-0 h-100">
                                                ...
                                                <ul class="nav small nav-divider mb-0">
                                                    ...
                                                    <li class="nav-item mb-0">
                                                        <i class="fa-solid fa-bed me-1"></i>@if($item->type == 'one')
                                                ...
                                                <div
                                                    ...
                                                    <div class="d-flex text-success">
                                                        <h6 class="h6 mb-0 text-success">{{number_format($item->price)}}
                                                        </h6>
                                                        <span class="fw-light"> /ຫ້ອງ/ຄືນ</span>
                                                    </div>
                                                    <a href="javascript:void(0)"
                                                        class="btn btn-sm btn-dark mb-0" wire:click="addRoom({{$item->id}})">ເລືອກຫ້ອງ</a>
                                                </div>
                                            </div>
                                        </div>
                                        <!-- Room detail START -->
                    ...
                    <div class="card bg-transparent border">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row g-4 mb-3">
                                ...
                                <div class="col-md-6">
                                    <div class="bg-light py-3 px-4 rounded-3">
                                        <h6 class="fw-light small mb-1" style="font-family: 'Phetsarath OT'">ເຂົ້າທີ່ພັກ</h6>
                                ...
                                <div class="col-md-6">
                                    <div class="bg-light py-3 px-4 rounded-3">
                                        <h6 class="fw-light small mb-1" style="font-family: 'Phetsarath OT'">ອອກທີ່ພັກ</h6>
                            ...
                            <ul class="list-group list-group-borderless mb-3">
									...
									@forelse ($details as $item)
										<li class="list-group-item px-2 d-flex justify-content-between">
											<span class="h6 fw-light mb-0" style="font-family: 'Phetsarath OT';">ຫ້ອງ {{$item->name}} {{number_format($item->price)}} x 2 ມື້</span>
											<span class="h6 fw-light mb-0">{{number_format($item->price * 2)}}</span>
										</li>
									@empty
									<li class="list-group-item px-2 d-flex justify-content-between text-center">
											<span class="h6 fw-light mb-0" style="font-family: 'Phetsarath OT';">ບໍ່ມີຂໍ້ມູນຫ້ອງພັກ</span>
										</li>
									@endforelse
                                ...
                                <li class="list-group-item bg-light d-flex justify-content-between rounded-2 px-2 mt-2">
                                    ...
                                    <span class="h5 fw-normal mb-0" style="font-family: 'Phetsarath OT';">{{number_format($sum)}} ກິບ</span>
                                </li>
                            </ul>
							<div class="row p-3">
								<div class="col-md-12">
									<input type="file" name="qr" id="qr" wire:model="img" class="form-control">
                            ...
                            <div class="d-grid gap-2">
                                <a href="javascript:void(0)" class="btn btn-dark mb-0" wire:click="payment">ຊຳລະ</a>
                            </div>
							<div class="row p-3">
								<div class="col-md-12">
