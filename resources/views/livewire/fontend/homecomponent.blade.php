        ...
        <div class="container">
            ...
            <div class="row g-4 g-lg-5">
                ...
                <div class="col-lg-6 position-relative mb-4 mb-md-0">
                    <!-- Title -->
                    <h1 class="mb-4 mt-md-5 display-5" style="font-family: 'Phetsarath OT'">ສູນລວມຈຸດພັກຜ່ອນໃນ ຫຼວງພະບາງ
                    ...
                    <!-- Info -->
                    <p class="mb-4">ຄົ້ນຫາທີ່ພັກທີ່ ທີ່ດີທີ່ສຸດໃນແຂວງຫຼວງພະບາງ ທີ່ທ່ານຕ້ອງການ, ຈຸດລວມທີ່ພັກທີ່ດີທີ່ສຸດ
                        Booking-Lpb.com</p>

                    <!-- Buttons -->
                    <div class="hstack gap-4 flex-wrap align-items-center">
                        <!-- Button -->
                        <a href="#" class="btn btn-primary-soft mb-0">ຄົ້ນຫາຕອນນີ້</a>
                        <!-- Story button -->
                        <a data-glightbox="" data-gallery="office-tour"
                            href="https://www.youtube.com/watch?v=YhMZtYWJaJ8" class="d-block">
                            <!-- Avatar -->
                            <div class="avatar avatar-md z-index-1 position-relative me-2">
                                <img class="avatar-img rounded-circle"
                                    src="{{asset('fontend/assets/images/avatar/12.jpg')}}" alt="avatar">
                                <!-- Video button -->
                                <div
                            ...
                            <div class="align-middle d-inline-block">
                                <h6 class="fw-normal small mb-0" style="font-family: 'Phetsarath OT'">ເບິ່ງ story</h6>
                            </div>
                        </a>
                    </div>
                </div>
                ...
                <div class="col-lg-6 position-relative">
                    ...
                    <img src="{{asset('fontend/assets/images/bg/06.jpg')}}" class="rounded" alt="">
                    ...
                    <div
                        ...
                        <img class="icon-lg shadow-lg border border-3 border-white rounded-circle"
                            src="{{asset('fontend/assets/images/category/hotel/4by3/11.jpg')}}" alt="avatar">
                        <img class="icon-xl shadow-lg border border-3 border-white rounded-circle"
                            src="{{asset('fontend/assets/images/category/hotel/4by3/12.jpg')}}" alt="avatar">
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-xl-10 position-relative mt-n3 mt-xl-n9">
                    <!-- Title -->
                    <h6 class="d-none d-xl-block mb-3" style="font-family: 'Phetsarath OT'">ກວດສອບທີ່ພັກ</h6>
                            ...
                            <div class="col-lg-4">
                                <div class="form-control-border form-control-transparent form-fs-md d-flex">
                                    ...
                                    <div class="flex-grow-1">
                                        ...
                                        <select class="form-select js-choice" data-search-enabled="true" wire:model="dis_id">
        ...
        <div class="container">
            <div class="row g-4 justify-content-between align-items-center">
                ...
                <div class="col-lg-5 position-relative">
                    <!-- Image -->
                    <img src="{{asset('upload/travel/phusy2.jpg')}}" class="rounded-3 position-relative" alt="">
                    ...
                    <div class="position-absolute bottom-0 start-0 z-index-1 mb-4 ms-5">
                        <div class="bg-body d-flex d-inline-block rounded-3 position-relative p-3">
                            ...
                            <!-- Element -->
                            <img src="{{asset('fontend/assets/images/element/01.svg')}}"
                                class="position-absolute top-0 start-0 translate-middle w-40px" alt="">

                            <!-- Avatar group -->
                            <div class="me-4">
                                <h6 class="fw-light" style="font-family: 'Phetsarath OT'">ຜູ້ໃຊ້</h6>
                                <!-- Avatar group -->
                                <ul class="avatar-group mb-0">
                                    <li class="avatar avatar-sm">
                                        <img class="avatar-img rounded-circle"
                                            src="{{asset('fontend/assets/images/avatar/01.jpg')}}" alt="avatar">
                                    </li>
                                    <li class="avatar avatar-sm">
                                        <img class="avatar-img rounded-circle"
                                            src="{{asset('fontend/assets/images/avatar/02.jpg')}}" alt="avatar">
                                    </li>
                                    <li class="avatar avatar-sm">
                                        <img class="avatar-img rounded-circle"
                                            src="{{asset('fontend/assets/images/avatar/03.jpg')}}" alt="avatar">
                                    </li>
                                    <li class="avatar avatar-sm">
                                        <img class="avatar-img rounded-circle"
                                            src="{{asset('fontend/assets/images/avatar/04.jpg')}}" alt="avatar">
                                    </li>
                                    <li class="avatar avatar-sm">
                ...
                <!-- Right side START -->
                <div class="col-lg-6">
                    <h2 class="mb-3 mb-lg-5" style="font-family: 'Phetsarath OT'">ຈຸດເລີ່ມຕົ້ນທີ່ດີທີ່ສຸດ!</h2>
                    <p class="mb-3 mb-lg-5">ຈອງໂຮງແຮມ ແລະ ຈຸດທີ່ພັກຂອງທ່ານກັບພວກເຮົາ, ຢ່າພາດຂ່າວສານຈາກ Booking-Lpb.com
                    </p>
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-sm-6">
                            ...
                            <h5 class="mt-2" style="font-family: 'Phetsarath OT'">ທີ່ພັກ ແລະ ອາຫານ</h5>
                            <p class="mb-0">ມີທີ່ພັກທີ່ສວຍງາມ ແລະ ອາຫານທີ່ແຊບສຸດທີ່ຈຸດໃກ້ຄຽງກັນ.</p>
                        </div>
                        <!-- Item -->
                        <div class="col-sm-6">
                            <div class="icon-lg bg-danger bg-opacity-10 text-danger rounded-circle"><i
                                    class="bi bi-stopwatch-fill"></i></div>
                            <h5 class="mt-2" style="font-family: 'Phetsarath OT'">ການບໍລິການ</h5>
                            <p class="mb-0">ບໍລິການວ່ອງໄວທັນໃຈເອີ້ນໄດ້ 25 ຊົ່ວໂມງ. </p>
                        </div>
                        <!-- Item -->
                        <div class="col-sm-6">
                            <div class="icon-lg bg-orange bg-opacity-10 text-orange rounded-circle"><i
                                    class="bi bi-shield-fill-check"></i></div>
                            <h5 class="mt-2" style="font-family: 'Phetsarath OT'">ລະບົບຄວາມປອດໄພສູງ</h5>
                            <p class="mb-0">ມີກ້ອງວົງຈອນ ແລະ ລັອກທີ່ແໜ້ນໜາ. </p>
                        </div>
                        <!-- Item -->
                        <div class="col-sm-6">
                            <div class="icon-lg bg-info bg-opacity-10 text-info rounded-circle"><i
                                    class="bi bi-lightning-fill"></i></div>
                            <h5 class="mt-2" style="font-family: 'Phetsarath OT'">ສະຖານທີ</h5>
                            <p class="mb-0">ມີຄວາມສະຫວ່າງງາມຕາ ບໍ່ມືດຈົນເກີນໄປ.</p>
                        </div>
                    </div>
                    <!-- Features END -->
                </div>
        ...
        <div class="container">
            ...
            <div class="row mb-4">
                <div class="col-12 text-center">
                    <h2 class="mb-0" style="font-family: 'Phetsarath OT'">ໂຮງແຮມຕ່າງໆ</h2>
                </div>
            </div>
                ...
                <div class="col-sm-6 col-xl-3">
                    ...
                    <div class="card card-img-scale overflow-hidden bg-transparent">
                        ...
                        <div class="card-img-scale-wrapper rounded-3">
                            <!-- Image -->
                            <img src="{{asset($item->img1)}}" class="card-img" alt="hotel image">
                            <!-- Badge -->
                            <div class="position-absolute bottom-0 start-0 p-3">
                                <div class="badge text-bg-dark fs-6 rounded-pill stretched-link"><i
                                        class="bi bi-geo-alt me-2"></i>{{$item->name}}</div>
                            </div>
                        </div>
...
Near by START -->
    <section>
        <div class="container">
            ...
            <div class="row mb-4">
                <div class="col-12 text-center">
                    <h2 class="mb-0" style="font-family: 'Phetsarath OT'">ຕົວເມືອງໃນຫຼວງພະບາງ</h2>
                </div>
            </div>
            ...
            <div class="row g-4 g-md-5">
                ...
                <div class="col-6 col-sm-4 col-lg-3 col-xl-2">
                    <div class="card bg-transparent text-center p-1 h-100">
                        <!-- Image -->
                        <img src="{{asset($item->img)}}" class="rounded-circle h-100" alt="{{$item->name}}"
                            height="200px">

                        <div class="card-body p-0 pt-3">
                            <h5 class="card-title"><a href="#" class="stretched-link">{{$item->name}}</a></h5>
                        </div>
                    </div>
                </div>
                <!-- Card item END -->
