            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">ຂໍ້ມູນຕຶກ</li>
                    </ol>
                </div>
                <h4 class="page-title">ຂໍ້ມູນຕຶກ</h4>
            </div>
        </div>
    </div>
    ...
    <div class="row">
                ...
                <div id="cardCollpase1" class="collapse show">
                    <div>
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('name') is-invalid @enderror"
                                            wire:model="name" placeholder="ຊື່ຕຶກ" wire:keydown.enter="store" require>
                        ...
                        <div class="card-footer">
                            ...
                            <a href="{{route('buildings')}}" class="btn btn-danger">ລ້າງຂໍ້ມູນ</a>
        ...
        <div class="col-lg-8">
            <div class="card-box">
                            ...
                            <div class="table-responsive mb-0" data-pattern="priority-columns">
                                ...
                                <table border="2" width="100%">
                                    ...
                                    <tbody>
                                        ...
                                        @empty
                                        <tr class="text-center">
                                            <td colspan="8" style="color: #787878;">ບໍ່ມີຂໍ້ມູນຕຶກ</td>
                                        </tr>
                                        @endforelse
                                    </tbody>
                                </table>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <span><br> ລວມຕຶກທັງໝົດ <span class="text-danger">{{$count}}</span> ລາຍການ</span>
                    </div>
                </div>
            </div>
        </div>
